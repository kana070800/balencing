...
DoneTK:
	...
	asr		Ang_GY_XH
	ror		Ang_GY_XL		;1/2		2*pi*x*(1/64)/(2*pi*x*(1/64)+1) = 0.75  >>  x = 30.56 hz
	mov		r5, Ang_GY_XH
	mov		r4, Ang_GY_XL
	asr		Ang_GY_XH
	ror		Ang_GY_XL		;1/4
