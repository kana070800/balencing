/*
 * test_integ_sat_x.asm
 *
 *  Created: 2025-07-14 ?? 2:07:22
 *   Author: kana0
 */ 
 ...
 #define	PWMMAX_H	high(2000)
 #define	PWMMAX_L	low(2000)
 #define	PWMMAX_MH	high(-2000)
 #define	PWMMAX_ML	low(-2000)
...
;==============================
	...
	rcall	TWI_Write
	ldi		I2Cdata, 0x1A			; configuration
	rcall	TWI_Write
	ldi		I2Cdata, 0x01			;
	rcall	TWI_Write
	rcall	TWI_Stop
	...
	rcall	TWI_Write
	ldi		I2Cdata, 0x0f			; 8khz / 1+249  = 32 hz  [0xfa]			(DLPF is disable = 8k, enable = 1k)
...
CONV_DEG:    ; 가속도 r5:r4 를 각도로 변환
	...
	ldi		temp, 15		; 무게중심-수평 오차 조정  77, 37
	add		r4, temp
	adc		r5, r0
